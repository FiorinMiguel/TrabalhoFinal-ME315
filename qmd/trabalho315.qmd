...
<img src="dataStructures.png" style="width:70%; margin-top:15px;"/>
...
dataset_eletric_cars = CSV.read("electric_vehicles_spec_2025.csv", DataFrame)
```
...
#| echo: true
#| eval: false
dataset_eletric_cars = dataset_eletric_cars.rename(columns={
    "Brand": "brand",
    "Model": "model",
    "Top.Speed.kmh": "top_speed_kmh",
...
<h3>Filtragem de Dados: <code>filter()</code></h3>
```{=html}
<p style="font-size:0.6em; color:#555;">
...
### Por que Julia se Destaca?

::: {style="position: relative; min-height: 400px;"}
<small>
-   Operações com DataFrames.jl são altamente otimizadas, oferecendo desempenho superior em grandes conjuntos de dados.\
-   A linguagem permite loops e transformações complexas com velocidade de código compilado sem bibliotecas externas.\
-   A sintaxe clara facilita a escrita de filtros, joins e agrupamentos de forma direta e legível.\
-   O suporte nativo a paralelização acelera tarefas intensivas de limpeza e processamento de dados.\
-   As funções vetorizadas e o broadcasting simplificam transformações colunares em tabelas de dados.\
:::
